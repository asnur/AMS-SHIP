                    ...
                    <div class="card-body">
                        <form action="{{ route('add-taskjob') }}" method="POST">
                            ...
                            <input class="form-control" type="number" name="interval"
                                placeholder="Input number of interval" required>
                            <label for="" class="font-weight-bold mt-3">Due Date (optional)</label>
                            <input class="form-control" type="date" name="due_date"
                                placeholder="Input number of interval">
