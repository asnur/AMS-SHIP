                            ...
                            <form action="{{ route('update-taskjob') }}" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" name="jobdesk" id="jobdesk" rows="5" placeholder="Input Jobdesk" required>{!! $taskjob->jobdesk !!}</textarea>
                                    </div>
                                    <div class="col-12">
                                        <label for="" class="font-weight-bold mt-3">Cost Estimation</label>
                                        <input class="form-control" type="number" name="cost" id="cost" placeholder="Input Cost Estimation" value="{{ $taskjob->cost }}" required>
                                    </div>
                                    <div class="col-10">
                                        <label for="" class="font-weight-bold mt-3">Freq</label>
                                        <input class="form-control" type="number" value="{{ $taskjob->freq }}" name="freq" id="freq" placeholder="Input number of frequencies" required>
                                    </div>
                                    <div class="col-2">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="number" name="interval" placeholder="Input number of interval" value="{{ $taskjob->interval }}" required>
                                    </div>
                                    <div class="col-12">
                                        <label for="" class="font-weight-bold mt-3">Due Date (optional)</label>
                                        <input class="form-control" type="date" name="due_date" placeholder="Input number of interval" value="{{ date('Y-m-d', strtotime($taskjob->due_date)) }}" required>
                                    </div>
                                    <div class="col-12">
                                        <label for="" class="font-weight-bold mt-3">Critical</label><br>
                                        <input type="radio" name="critical" value="1" {{ $taskjob->critical == 1 ? 'checked' : '' }} required> Yes
                                        <input type="radio" name="critical" value="0" {{ $taskjob->critical == 0 ? 'checked' : '' }} required> No
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-success mt-3"><i class="fa fa-paper-plane"></i>Send</button>
                                    </div>
                                </div>
                            </form>
                        </div>
